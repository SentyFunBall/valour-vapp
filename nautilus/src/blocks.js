...
const code = 'Valour.role_add(name, member);\n';
return code;
};
...
const code = 'Valour.role_remove(name, member);\n';
return code;
};
...
const code = 'Valour.kick(member, reason);\n';
return code;
};
...
const code = 'Valour.ban(member, reason);\n';
return code;
};
...
const code = 'Valour.get_value(value, from)';
...
const code = 'Valour.message_info(info)';
...
const code = 'Valour.message_id(id);';
